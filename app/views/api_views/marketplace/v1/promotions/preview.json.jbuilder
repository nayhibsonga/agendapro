json.array!(@results) do |result|
  ...
  json.min_price number_to_currency(result[0].price*(100-result[0].get_max_discount)/100, currency: '$ ', separator: '.', delimeter: ',', precision: 0)
  json.max_discount '-' + result[0].get_max_discount.to_s + '%'
