json.array!(@results) do |location|
  ...
  json.logo location.company.logo && location.company.logo.page && location.company.logo.page.url && location.company.logo.page.url.include? "/assets/logo_vacio" ? request.protocol + request.host_with_port + location.company.logo.page.url : request.protocol + request.host_with_port + "/assets/default_marketplace.png"
