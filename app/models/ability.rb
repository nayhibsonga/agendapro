class Ability
  ...
  def initialize(user)
    ...
    #Open Day Check
    can :is_open, Location
    can :is_open, ServiceProvider
    ...
    if user.role_id == Role.find_by_name("Super Admin").id
        ...
        can :activate, Product, :company_id => user.company_id
        can :deactivate, Product, :company_id => user.company_id

        #Open Day
        can :create_open_day, Location, :company_id => user.company_id
        can :update_open_day, Location, :company_id => user.company_id
        can :delete_open_day, Location, :company_id => user.company_id
        can :create_open_day, ServiceProvider, :company_id => user.company_id
        can :update_open_day, ServiceProvider, :company_id => user.company_id
        can :delete_open_day, ServiceProvider, :company_id => user.company_id
        can :show_open_day, ServiceProvider, :company_id => user.company_id
        can :show_open_day, Location, :company_id => user.company_id
        ...
        can :read, SurveyAnswer, :company_id => user.company_id
        can :destroy, SurveyAnswer, :company_id => user.company_id
        can :create, SurveyAnswer, :company_id => user.company_id
        can :update, SurveyAnswer, :company_id => user.company_id
        can :status_details, SurveyAnswer, :company_id => user.company_id
        ...
        can :past_payments, Client, :company_id => user.company_id
        can :associate_payment, Booking, :company_id => user.company_id
    ...
    elsif user.role_id == Role.find_by_name("Recepcionista (sin edición)").id
