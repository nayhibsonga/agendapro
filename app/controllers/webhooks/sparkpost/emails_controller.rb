        ...
        if message_event.present? && message_event["rcpt_meta"].present?
          if message_event["rcpt_meta"]["booking_ids"].present?
            message_event["rcpt_meta"]["booking_ids"].each do |booking_id|
              ...
              log.assign_attributes(status: message_event["type"], recipient: message_event["rcpt_to"], timestamp: DateTime.strptime(message_event["timestamp"],'%s'), subject: message_event["subject"])
              log.save
            end
