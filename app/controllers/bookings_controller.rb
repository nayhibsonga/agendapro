class BookingsController < ApplicationController
  ...
  before_action :authenticate_user!, except: [:create, :provider_booking, :book_service, :edit_booking, :cancel_booking]
  before_action :quick_add, except: [:create, :provider_booking, :book_service, :edit_booking, :cancel_booking]
  layout "admin", except: [:book_service, :provider_booking, :edit_booking, :cancel_booking]
