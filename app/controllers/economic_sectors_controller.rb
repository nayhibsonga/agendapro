class EconomicSectorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @economic_sector.save
        format.html { redirect_to economic_sectors_path, notice: 'Sector Económico fue creado exitosamente.' }
  ...
  def update
    respond_to do |format|
      if @economic_sector.update(economic_sector_params)
        format.html { redirect_to economic_sectors_path, notice: 'Sector Económico fue actualizado exitosamente.' }
  ...
  private
    ...
    def economic_sector_params
      params.require(:economic_sector).permit(:name, economic_sectors_dictionaries_attributes: [:id, :name, :_destroy])
    end
end
