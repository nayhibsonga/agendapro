  ...
  def create
    ...
    respond_to do |format|
      if @economic_sector.save
        format.html { redirect_to @economic_sector, notice: 'Economic sector was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @economic_sector.update(economic_sector_params)
        format.html { redirect_to @economic_sector, notice: 'Economic sector was successfully updated.' }
