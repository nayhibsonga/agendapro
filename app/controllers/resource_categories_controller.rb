  ...
  def create
    ...
    respond_to do |format|
      if @resource_category.save
        format.html { redirect_to resource_categories_path, notice: 'El recurso fue creado exitosamente.' }
  ...
  def update
    respond_to do |format|
      if @resource_category.update(resource_category_params)
        format.html { redirect_to resource_categories_path, notice: 'El recurso fue editado exitosamente.' }
        format.json { render :json => @resource_category }
      else
