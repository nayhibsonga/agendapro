$(function () {
	...
	$('input[name="sizeLinkRadio"]').change(function () {
		$('input[name="sizeImageRadio"]').prop('checked', false);
		$('input[name="sizeButtonRadio"]').prop('checked', false);
		var extLink = '<a href="http://' + web_address + '.agendapro.cl" target="_blank" style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;text-decoration: none;color: #428bca;">Reserva en Linea</a>';
		extLink = extLink.replace(/</g, '&lt;').replace(/>/g, '&gt;');
		$('pre').empty();
		$('pre').append(extLink);
	});
