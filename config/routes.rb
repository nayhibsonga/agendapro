Agendapro::Application.routes.draw do
  ...
  scope "(:locale)", locale: /es|es_CL|es_CO|es_PA|es_VE|es_GT|es_PE|es_AR/ do
    ...
    resources :survey_question_constructs
    resources :survey_question_recommendations
    resources :survey_attributes
    ...
    # Reporting Survey
    get '/survey_report_status_details', :to => 'survey_answers#status_details'
    ...
    post '/associate_payment', :to => 'bookings#associate_payment'
    ...
    get '/clients_past_payments', :to => 'clients#past_payments'
    ...
    get '/payment_client_treatments', :to => 'payments#client_treatments'
    ...
    # Root
    get '', :to => 'home#index', :as => 'localized_root2', :constraints => { :subdomain => 'www' }
    get '', :to => 'companies#overview', :constraints => { :subdomain => /.+/ }
    get '', :to => 'home#index', :as => 'localized_root'
    get '/searchs', :to => 'searchs#index', :as => 'localized_search'
    get '/landing', :to => 'searchs#landing', :as => 'landing'
    get "/searchs/index", :to => "searchs#index"
    ...
    patch '/products/:id/activate', :to => 'products#activate', :as => 'activate_product'
    ...
    #Open day routes
    get '/location_open', :to => 'locations#is_open'
    post '/open_location_day', :to => 'locations#create_open_day'
    patch '/update_location_day', :to => 'locations#update_open_day'
    delete '/delete_location_day', :to => 'locations#delete_open_day'
    get '/show_location_day', :to => 'locations#show_open_day'
    get '/provider_open', :to => 'service_providers#is_open'
    post '/open_provider_day', :to => 'service_providers#create_open_day'
    patch '/update_provider_day', :to => 'service_providers#update_open_day'
    delete '/delete_provider_day', :to => 'service_providers#delete_open_day'
    get '/show_provider_day', :to => 'service_providers#show_open_day'
