Agendapro::Application.routes.draw do
  ...
  get "/punto_pagos/success/:trx_id", :to => 'punto_pagos#success', :as => 'punto_pagos_success_trx'
  get "/punto_pagos/failure/:trx_id", :to => 'punto_pagos#failure', :as => 'punto_pagos_failure_trx'
