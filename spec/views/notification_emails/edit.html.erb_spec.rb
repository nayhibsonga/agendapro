...
RSpec.describe "notification_emails/edit", :type => :view do
  before(:each) do
  ...
  it "renders the edit notification_email form" do
    render

    assert_select "form[action=?][method=?]", notification_email_path(@notification_email), "post" do
