  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved attribute as @attribute" do
        post :create, {:attribute => invalid_attributes}, valid_session
        expect(assigns(:attribute)).to be_a_new(Attribute)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested attribute" do
        attribute = Attribute.create! valid_attributes
        put :update, {:id => attribute.to_param, :attribute => new_attributes}, valid_session
        attribute.reload
    ...
    describe "with invalid params" do
      it "assigns the attribute as @attribute" do
        attribute = Attribute.create! valid_attributes
        put :update, {:id => attribute.to_param, :attribute => invalid_attributes}, valid_session
        expect(assigns(:attribute)).to eq(attribute)
      end
