  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved bundle as @bundle" do
        post :create, {:bundle => invalid_attributes}, valid_session
        expect(assigns(:bundle)).to be_a_new(Bundle)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested bundle" do
        bundle = Bundle.create! valid_attributes
        put :update, {:id => bundle.to_param, :bundle => new_attributes}, valid_session
        bundle.reload
    ...
    describe "with invalid params" do
      it "assigns the bundle as @bundle" do
        bundle = Bundle.create! valid_attributes
        put :update, {:id => bundle.to_param, :bundle => invalid_attributes}, valid_session
        expect(assigns(:bundle)).to eq(bundle)
      end
