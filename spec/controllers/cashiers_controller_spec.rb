  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved cashier as @cashier" do
        post :create, {:cashier => invalid_attributes}, valid_session
        expect(assigns(:cashier)).to be_a_new(Cashier)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested cashier" do
        cashier = Cashier.create! valid_attributes
        put :update, {:id => cashier.to_param, :cashier => new_attributes}, valid_session
        cashier.reload
    ...
    describe "with invalid params" do
      it "assigns the cashier as @cashier" do
        cashier = Cashier.create! valid_attributes
        put :update, {:id => cashier.to_param, :cashier => invalid_attributes}, valid_session
        expect(assigns(:cashier)).to eq(cashier)
      end
