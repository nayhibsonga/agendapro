...
<<<<<<< HEAD
ActiveRecord::Schema.define(version: 20160901043008) do
=======
ActiveRecord::Schema.define(version: 20160914130121) do
>>>>>>> mailing2
  ...
  create_table "api_post_urls", force: true do |t|
    t.string   "post_url",    default: "",    null: false
    t.boolean  "post_url_ok", default: false, null: false
  ...
  add_index "api_post_urls", ["company_id"], name: "index_api_post_urls_on_company_id", using: :btree
  ...
  add_index "client_comments", ["last_modifier_id"], name: "index_client_comments_on_last_modifier_id", using: :btree
  ...
  create_table "companies", force: true do |t|
    ...
    t.string   "secret_key",          default: "3h9rv7gp2tbmgbt4027z5i4cxnvpfxdt0koju1bb44z", null: false
  end
  ...
  create_table "company_settings", force: true do |t|
    ...
    t.string   "color_dark"
    t.boolean  "activate_api_post",           default: false,                 null: false
<<<<<<< HEAD
=======
...
>>>>>>> mailing2
  ...
  add_index "survey_answers", ["booking_id"], name: "index_survey_answers_on_booking_id", using: :btree
  add_index "survey_answers", ["survey_question_id"], name: "index_survey_answers_on_survey_question_id", using: :btree

  create_table "survey_attributes", force: true do |t|
    t.string   "name"
    t.string   "description"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "survey_question_constructs", force: true do |t|
    t.integer  "survey_question_id"
    t.integer  "survey_construct_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  add_index "survey_question_constructs", ["survey_construct_id"], name: "index_survey_question_constructs_on_survey_construct_id", using: :btree
  add_index "survey_question_constructs", ["survey_question_id"], name: "index_survey_question_constructs_on_survey_question_id", using: :btree

  create_table "survey_question_recommendations", force: true do |t|
    t.string   "name"
    t.string   "description"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "survey_questions", force: true do |t|
    ...
    t.integer  "order"
    t.integer  "survey_attribute_id"
    t.integer  "company_id"
    t.boolean  "activate"
  end

  add_index "survey_questions", ["company_id"], name: "index_survey_questions_on_company_id", using: :btree
  add_index "survey_questions", ["survey_attribute_id"], name: "index_survey_questions_on_survey_attribute_id", using: :btree
